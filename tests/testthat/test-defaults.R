...
test_that("default_azure_scope accepts short names without azure_ prefix", {
  ...
  expect_equal(
    default_azure_scope("key_vault"),
    "https://vault.azure.net/.default"
  )
  expect_equal(
    default_azure_scope("openai"),
    "https://cognitiveservices.azure.com/.default"
  )
  expect_equal(
    default_azure_scope("log_analytics"),
    "https://api.loganalytics.io/.default"
  )
  expect_equal(
    default_azure_scope("app_insights"),
    "https://api.applicationinsights.io/.default"
  )
  expect_equal(
    default_azure_scope("databricks"),
    "https://databricks.azure.com/.default"
  )
  expect_equal(
    default_azure_scope("sql"),
    "https://database.windows.net/.default"
  )
  expect_equal(
    default_azure_scope("service_bus"),
    "https://servicebus.azure.net/.default"
  )
})
