...
to provide a Kusto Query Language (KQL) `query()` method against the
public Azure Log Analytics REST API, bound to a specific Azure
subscription and resource group at construction.
...
- [`api_client$.build_request()`](https://pedrobtz.github.io/azr/dev/reference/api_client.html#method-.build_request)
- [`api_client$.fetch()`](https://pedrobtz.github.io/azr/dev/reference/api_client.html#method-.fetch)
- [`api_client$.get_token()`](https://pedrobtz.github.io/azr/dev/reference/api_client.html#method-.get_token)
- [`api_client$.resp_body_content()`](https://pedrobtz.github.io/azr/dev/reference/api_client.html#method-.resp_body_content)
- [`api_client$.resp_content()`](https://pedrobtz.github.io/azr/dev/reference/api_client.html#method-.resp_content)
- [`api_client$.send_request()`](https://pedrobtz.github.io/azr/dev/reference/api_client.html#method-.send_request)
